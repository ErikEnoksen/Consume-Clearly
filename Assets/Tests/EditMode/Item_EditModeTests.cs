...
namespace Tests.EditMode
{
    ...
    public class Item_EditModeTests
    {
        ...
        {
            item.Initialize("Wood", 1, null, "A plank of wood", 10, "Untagged");
        ...
        {
            item.Initialize("Stone", 5, null, "", 20, "Untagged");
        ...
        {
            item.Initialize("Stone", 1, null, "", 15, "Untagged");
        ...
        {
            item.Initialize("Herb", 1, null, "A healing herb", 5, "Untagged");
        ...
        public void Initialize_SetsSprite()
        {
            ...
            item.Initialize("Icon", 1, sprite, "", 1, "Untagged");
        ...
        {
            item.Initialize("Plank", 1, null, "", 10, "Untagged");
        ...
        {
            item.Initialize("Rock", 1, null, "", 5, "Untagged");
